...
ALTER TABLE public.mensajes_whatsapp ADD COLUMN IF NOT EXISTS canal_id TEXT NOT NULL DEFAULT '';
...
CREATE INDEX IF NOT EXISTS mensajes_whatsapp_canal_id_idx ON public.mensajes_whatsapp(canal_id);
