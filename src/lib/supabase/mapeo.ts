...
export function aExpediente(fila: FilaExpediente): Expediente {
  return {
    ...
    tipoNegocio: fila.tipo_negocio ?? "construccion-impermeabilizacion",
...
export function aFila(datos: DatosExpediente) {
  return {
    ...
    tipo_negocio: (datos.tipoNegocio && datos.tipoNegocio.trim()) ? datos.tipoNegocio : "construccion-impermeabilizacion",
