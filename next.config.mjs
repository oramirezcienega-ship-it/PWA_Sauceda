...
const csp = [
  ...
  "form-action 'self'",
  "img-src 'self' data: blob: https://*.supabase.co https://*.saucedamx.com https://*.replicate.delivery https://replicate.delivery https://*.r2.cloudflarestorage.com https://*.cloudflarestorage.com https://*.replicate.com https://*.canva.com http://localhost:* http://127.0.0.1:* http://192.168.100.*",
  "font-src 'self'",
  ...
  "media-src 'self' blob: https://*.vapi.ai https://*.twilio.com https://*.amazonaws.com https://*.r2.cloudflarestorage.com https://*.cloudflarestorage.com https://*.replicate.delivery",
  "manifest-src 'self'",
  "worker-src 'self'",
].join("; ");
